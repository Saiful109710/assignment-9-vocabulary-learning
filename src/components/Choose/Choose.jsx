...
const Choose = () => {
  return (
   <>
         <section data-aos="zoom-in" className="features-section bg-gray-50 py-12 mt-10">
    <div className="max-w-6xl mx-auto px-6 text-center">
      <h2 className="text-4xl font-bold text-gray-800 mb-6">Why Choose Us?</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div data-aos="zoom-in-up" className="p-6 bg-white shadow-lg rounded-lg">
        ...
        <div data-aos="zoom-in-down" className="p-6 bg-white shadow-lg rounded-lg">
        ...
        <div  data-aos="zoom-in-left" className="p-6 bg-white shadow-lg rounded-lg">
  ...
  <section data-aos="fade-down"
     ...
     data-aos-duration="1500" className="cta-section py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center mt-10 mb-10">
