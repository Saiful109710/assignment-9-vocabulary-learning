...
const Banner = () => {
  ...
  return (
     ...
     <section data-aos="fade-down-right" className="slider-section grid grid-cols-1 md:grid-cols-2 mb-10 mt-5 p-5">
        <div data-aos='fade-up' className='md:w-4/5 space-y-5 py-5 '>
                ...
                <p className='text-xl text-justify'>Unlock the beauty of the Korean language with an interactive and fun learning experience. Explore lessons, practice real-life scenarios, and grow your skills one word at a time!</p>
